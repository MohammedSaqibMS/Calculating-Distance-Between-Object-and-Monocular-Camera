...
*Overview of the detection → depth estimation → distance calculation pipeline. Replace with your own diagram/screenshot.*
...
![Reference calibration example](assets/calibration_example.png)
*Example of the calibration step: object placed at a known distance with its detected bounding box and center point marked. Replace with your own screenshot.*
...
![Depth map example](assets/depth_map_example.png)
*Example depth map generated by Depth Anything V2 for a sample frame. Replace with your own output.*
